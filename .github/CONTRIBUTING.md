...
The `README` contains badges for the continuous integration services used by the
package.  
*  New code should follow the tidyverse [style guide](http://style.tidyverse.org).
You can use the air package to apply these styles. You can format your code automatically by commenting `/style` on your PR.  
