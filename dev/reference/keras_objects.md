...
[`optimizer_function()`](https://davidrsch.github.io/kerasnip/dev/reference/optimizer_function.md)
and
[`loss_function_keras()`](https://davidrsch.github.io/kerasnip/dev/reference/loss_function_keras.md).
