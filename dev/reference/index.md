...
- [`axe_data(`*`<kerasnip_model_fit>`*`)`](https://davidrsch.github.io/kerasnip/dev/reference/axe-kerasnip_model_fit.md)
  [`axe_env(`*`<kerasnip_model_fit>`*`)`](https://davidrsch.github.io/kerasnip/dev/reference/axe-kerasnip_model_fit.md)
  [`axe_call(`*`<kerasnip_model_fit>`*`)`](https://davidrsch.github.io/kerasnip/dev/reference/axe-kerasnip_model_fit.md)
  [`axe_ctrl(`*`<kerasnip_model_fit>`*`)`](https://davidrsch.github.io/kerasnip/dev/reference/axe-kerasnip_model_fit.md)
  [`axe_fitted(`*`<kerasnip_model_fit>`*`)`](https://davidrsch.github.io/kerasnip/dev/reference/axe-kerasnip_model_fit.md)
