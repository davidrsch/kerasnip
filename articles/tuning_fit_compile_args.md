...
Fit arguments can be written either with the `fit_` prefix
(`fit_epochs`) or without it (`epochs`), matching the names used by
other tidymodels neural-network engines. When both are supplied, the
`fit_` version takes precedence.
...
#> 1       0.01             16         30 adam              kl_divergence   accura…
#> 2       0.01             16         30 adam              categorical_cr… accura…
...
#>        <dbl>          <int>      <int> <chr>             <chr>         <chr>    
#> 1       0.01             16         30 adam              kl_divergence pre0_mod…
```
...
#> 
#> $keras_bytes
#>     [1] 50 4b 03 04 14 00 00 00 00 00 00 00 21 00 09 f9 08 10 40 00 00 00 40 00
...
#>    [97] 40 31 37 3a 30 33 3a 32 39 22 7d 50 4b 03 04 14 00 00 00 00 00 00 00 21
#>   [121] 00 88 ab c2 37 80 0b 00 00 80 0b 00 00 0b 00 00 00 63 6f 6e 66 69 67 2e
...
#>   [385] 20 31 34 30 31 32 35 37 35 33 37 30 31 39 36 38 7d 2c 20 22 6c 61 79 65
