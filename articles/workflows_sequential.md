...
#> 4             32           0.1             40         0.400 accuracy multiclass
#> 5             32           0.1             64         0.25  accuracy multiclass
...
#> 
#> $keras_bytes
#>     [1] 50 4b 03 04 14 00 00 00 00 00 00 00 21 00 7f 2a 6b 2e 40 00 00 00 40 00
...
#>    [73] 64 61 74 65 5f 73 61 76 65 64 22 3a 20 22 32 30 32 36 2d 30 35 2d 30 37
#>    [97] 40 32 32 3a 33 33 3a 32 37 22 7d 50 4b 03 04 14 00 00 00 00 00 00 00 21
#>   [121] 00 3f a8 71 2f 17 11 00 00 17 11 00 00 0b 00 00 00 63 6f 6e 66 69 67 2e
...
#>   [217] 73 65 71 75 65 6e 74 69 61 6c 5f 34 30 30 22 2c 20 22 74 72 61 69 6e 61
...
#>   [385] 3a 20 31 34 30 35 36 30 31 39 30 37 31 31 37 36 30 7d 2c 20 22 6c 61 79
...
#>   [577] 6c 61 79 65 72 5f 34 30 30 22 2c 20 22 6f 70 74 69 6f 6e 61 6c 22 3a 20
...
#>   <fct>   <fct>              <dbl>           <dbl>        <dbl>
#> 1 Adelie  Adelie             1.000        1.15e-11     3.43e-10
#> 2 Adelie  Adelie             1.000        8.99e- 8     7.42e- 7
#> 3 Adelie  Adelie             1.000        4.08e-12     2.50e-11
#> 4 Adelie  Adelie             1.000        3.90e-10     9.31e- 9
#> 5 Adelie  Adelie             1.000        6.87e- 9     1.80e- 8
#> 6 Adelie  Adelie             1.000        1.24e- 9     6.54e- 8
